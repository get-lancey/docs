...
5. Add another action step, set the app to Lancey, and choose "Create Meeting". Connect your Lancey account using the access token generated in step 1.
...
#### Meeting ID
- **Description:** The unique identifier for the meeting, provided by your trigger app.
- **Required:** Yes
